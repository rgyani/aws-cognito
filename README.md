...
You can, but ideally this is not what cognito is for.    
Ideally, you would want your user information stored in a RDS/Dynamo while Cognito is used for scenarios where you want to grant temporary credentials to access your services.
